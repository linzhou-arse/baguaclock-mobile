...
class ZhiyeScreen(MDScreen):
    ...
    def build_ui(self):
        ...
        btn_analyze.bind(on_press=self.analyze_zhiye)
    ...
    def analyze_zhiye(self, instance):
        """分析职业"""
        ...
        try:
            ...
            # 执行分析
            result = service.analyze_career(pillars, day_master, gender, self.bazi_result)
    ...
    def display_result(self, data):
        ...
        career_layout = MDBoxLayout(
            orientation='vertical',
            spacing=10
        )
        career_title = MDLabel(
            text="职业建议",
            theme_text_color="Primary",
            font_style="H6",
            size_hint_y=None,
        ...
        career_layout.add_widget(career_title)
        career_layout.add_widget(career_summary)
        career_card.add_widget(career_layout)
        self.result_container.add_widget(career_card)
